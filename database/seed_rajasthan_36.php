<?php
// CLI-only. Idempotent: imports the 36 Rajasthan city "website designer / software developer /
// web development company / software development" landing pages from
// database/data/rajasthan_36.json into seo_pages, following the same pattern as
// seed_seo_pages_india_16.php — one 'html' content_sections block per page, h1 and the FAQ
// section excluded from that HTML since the page component renders page.h1 and the faqs list
// separately. Target location is the page's city, taken directly from the source data.
...
$pages = json_decode(file_get_contents(__DIR__ . '/data/rajasthan_36.json'), true);
