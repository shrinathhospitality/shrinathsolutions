<?php
// CLI-only. Idempotent: imports the 16 India city "web development / software development /
// website designer" SEO landing pages from database/data/seo_pages_india_16.json into
// seo_pages, following the same pattern as seed_seo_pages_batch1.php — one 'html'
// content_sections block per page (rendered via RichContent on the public DynamicSeoPage
// catch-all route), h1 and the FAQ section excluded from that HTML since the page component
// renders page.h1 and the faqs list separately. Target location is the page's city, taken
// directly from the source data rather than guessed from the title. Safe to re-run — skips
...
$pages = json_decode(file_get_contents(__DIR__ . '/data/seo_pages_india_16.json'), true);
