...
type Form = {
  ...
  display_order: number; is_featured: boolean; cta_heading: string; cta_body: string; status: string;
};
...
const empty: Form = {
  ...
  cta_heading: '', cta_body: '', status: 'draft',
};
...
export default function PortfolioEdit() {
  ...
  async function onSubmit(e: FormEvent) {
    ...
    const payload = {
      ...
      cta_heading: form.cta_heading || null, cta_body: form.cta_body || null, status: form.status, seo,
    };
