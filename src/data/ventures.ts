...
export const ventures: Venture[] = [
  {
    ...
    phoneNumbers: ['9414319897', '7014259990'],
    googleBusinessUrl: 'https://share.google/mfS4YHPYDDjmztf2o',
    theme: {
      layoutVariant: 'heritage-craft',
      primary: '#7a1f1f',
      secondary: '#3a2a1c',
      accent: '#b08d57',
      background: '#f4ecdc',
    ...
    sections: [
      {
        heading: 'A Craft Passed Down Over Four Decades',
        body: 'Shrinath Rubber Stamp has been part of Jaisalmer’s everyday business life for forty years. Long before digital signatures and printed letterheads became common, this workshop was already producing the stamps that offices, schools, hotels and shopkeepers relied on to authenticate their paperwork. That continuity is the business’s real legacy: the same attention to detail, carried forward across a generation of customers who return not because of a marketing campaign, but because the stamps simply work, order after order.',
      },
      {
        heading: 'Who Uses Our Stamps',
        body: 'Government and private offices use our stamps for approvals, dispatch and correspondence. Hotels and guesthouses use them for registers, checks-in and billing. Schools use them for attendance, certificates and administrative records. Shops, clinics and independent professionals use name and designation stamps for daily paperwork. Whatever the setting, the requirement is the same: a stamp that is legible, durable and made correctly the first time.',
      },
      {
        heading: 'Enquiry-First, Not Assumption-First',
        body: 'Every stamp is different — the wording, the layout, the size, the ink colour. Rather than listing fixed products with fixed turnaround promises, we treat each requirement as an enquiry: you tell us what the stamp needs to say and where it will be used, we confirm the layout with you, and then production begins. This keeps mistakes low and ensures the finished stamp matches exactly what you intended.',
      },
    ],
    faqs: [
    ...
    seo: {
      title: 'Shrinath Rubber Stamp Jaisalmer | 40 Years of Stamp Craft',
      description: 'Shrinath Rubber Stamp is a 40-year-old Jaisalmer business making traditional, self-inking, date and custom rubber stamps for offices, hotels, schools and shops.',
      canonicalPath: '/our-ventures/shrinath-rubber-stamp',
    },
  },

  {
    ...
    phoneNumbers: ['7727971536'],
    googleBusinessUrl: 'https://share.google/lH6ay5MYVfGftYNWk',
    theme: {
      layoutVariant: 'technical-grid',
      primary: '#0f5fd6',
      secondary: '#1f2733',
      accent: '#f5a524',
      background: '#f4f6fa',
    ...
    seo: {
      title: 'Shrinath Enterprise Jaisalmer | CCTV, Security & IT Solutions',
      description: 'Shrinath Enterprise supplies CCTV, security systems, EPABX, boom barriers and computer hardware for hotels, offices and institutions in Jaisalmer.',
      canonicalPath: '/our-ventures/shrinath-enterprise',
    },
  },

  {
    ...
    phoneNumbers: ['9694994943'],
    email: 'shrinathdesertcamp@gmail.com',
    website: 'https://shrinathdesertcamp.com/',
    googleBusinessUrl: 'https://share.google/xWyblhTKWwIWQkIah',
    theme: {
      layoutVariant: 'cinematic-desert',
      primary: '#d9782e',
      secondary: '#1b1533',
      accent: '#f2c14e',
      background: '#211a35',
    ...
    sections: [
      {
        heading: 'An Overnight Escape Into the Thar',
        body: 'Shrinath Desert Camp offers a night in the desert without needing to plan every detail yourself — a tent to stay in, a camel or jeep ride across the dunes, a cultural evening, dinner, and a sky full of stars once the lights of the city are far behind. It is built for travellers who want to experience the Thar Desert directly rather than just pass through it.',
      },
      {
        heading: 'A Stay Suited to Different Travellers',
        body: 'Couples looking for a quiet evening under the stars, families wanting a safe and comfortable introduction to desert travel, and groups of friends looking for a shared adventure all find a version of the experience that suits them at the camp. The core elements — tents, safari options, the evening programme and dinner — stay the same; how you experience them is up to you.',
      },
      {
        heading: 'Planning Your Visit',
        body: 'For current availability, exact packages and pricing, the official Shrinath Desert Camp website and direct enquiry contacts are the best source of accurate, up-to-date information. This page is an introduction to the experience — for booking details, please reach out directly or visit the website.',
      },
    ],
    faqs: [
    ...
    seo: {
      title: 'Shrinath Desert Camp | Desert Camp in Jaisalmer',
      description: 'Shrinath Desert Camp offers desert tent stays near Jaisalmer with camel and jeep safaris, a cultural evening and desert dining under the stars.',
      canonicalPath: '/our-ventures/shrinath-desert-camp',
    },
  },

  {
    ...
    phoneNumbers: ['7878656767'],
    email: 'shrinathadventures@gmail.com',
    website: 'https://shrinathadventures.com/',
    googleBusinessUrl: 'https://share.google/ikIm572RfHZazKSMk',
    theme: {
      layoutVariant: 'route-planner',
      primary: '#1e3a8a',
      secondary: '#7c3f22',
      accent: '#c9a24b',
      background: '#f7f3ea',
    ...
    sections: [
      {
        heading: 'Local Knowledge, Full-Trip Planning',
        body: 'Shrinath Adventures plans trips across Jaisalmer, Jodhpur, Jaipur, Udaipur and wider Rajasthan, extending into pan-India travel when a trip calls for it. Being based in Jaisalmer means the planning starts with genuine local knowledge — not a generic route pulled from a brochure — and extends outward as your itinerary grows.',
      },
      {
        heading: 'A Simple Four-Step Process',
        body: 'It starts with a conversation about where you want to go and what kind of trip you are looking for. From there we put together a draft itinerary, coordinate the hotels, camps and transport that fit it, and stay available to adjust things as your plans firm up. The result is a trip that is planned around you, not fitted into a fixed package.',
      },
      {
        heading: 'Built for Every Kind of Traveller',
        body: 'Couples planning a quiet Rajasthan trip, families needing a comfortable and well-paced route, groups of friends wanting a shared adventure, and travellers who want a fully custom tour all work with the same planning process — adapted to what matters most for that trip.',
      },
    ],
    faqs: [
    ...
    seo: {
      title: 'Shrinath Adventures | Rajasthan & India Tour Planner',
      description: 'Shrinath Adventures plans Rajasthan and India trips — itineraries, hotel and camp coordination, transport and activities — from local Jaisalmer expertise.',
      canonicalPath: '/our-ventures/shrinath-adventures',
    },
  },

  {
    ...
    phoneNumbers: ['7891911536'],
    email: 'smasanddunesdmc@gmail.com',
    website: 'https://samsanddunesdesertsafari.com/',
    googleBusinessUrl: 'https://share.google/GPJwOC4Pq0ByWNaW4',
    theme: {
      layoutVariant: 'b2b-trade',
      primary: '#0f766e',
      secondary: '#3b2a1e',
      accent: '#d8a24a',
      background: '#f6f1e7',
    ...
    sections: [
      {
        heading: 'A Trade Desk for Sam Sand Dunes',
        body: 'Sam Sand Dunes Desert Camp DMC exists specifically for travel agents and group organisers who need reliable desert-camp coordination at Sam Sand Dunes without managing every property relationship themselves. It is a trade-facing operation — built around allocation, rates and group logistics rather than individual holiday planning.',
      },
      {
      ...
      {
        heading: 'How a Trade Enquiry Works',
        body: 'Submit your group’s travel dates, guest count, room or tent requirement, and any meal or activity needs through the enquiry form below, or contact us directly. We will respond with camp options, rates and availability so you can confirm the booking with your client.',
      },
    ],
    faqs: [
    ...
    seo: {
      title: 'Sam Sand Dunes Desert Camp DMC | Jaisalmer B2B Camp Support',
      description: 'Sam Sand Dunes Desert Camp DMC provides B2B desert-camp sourcing, group booking coordination and competitive trade rates for travel agents in Jaisalmer.',
      canonicalPath: '/our-ventures/sam-sand-dunes-desert-camp-dmc',
    },
  },

  {
    ...
    theme: {
      layoutVariant: 'portfolio-management',
      primary: '#14532d',
      secondary: '#3f3f2f',
      accent: '#c9a45c',
      background: '#faf7f0',
    ...
    sections: [
      {
        heading: 'Marketing and Management Support for Hotel Owners',
        body: 'Shrinath Hospitality works with hotel and resort owners on the marketing and management side of running a property — positioning, direct-enquiry support, OTA presence and sales coordination. The goal is straightforward: help a property be found, understood and booked, while giving the owner a single point of contact for that side of the business.',
      },
      {
        heading: 'Properties We Work With',
        body: 'We currently work with Hotel Garh Adhiraj, KK Desert Camp & Resort, Lakhmana Desert Camp, Vijaybagh Resort, Hotel Elite Castle, Hotel Vasshifa and Hotel Narpat Garh Palace, in a managed, marketed or associated capacity depending on the specific relationship with each property.',
      },
      {
        heading: 'Add Your Hotel',
        body: 'If you own or operate a hotel, resort or desert camp around Jaisalmer and are exploring marketing or management support, we welcome a conversation. Property onboarding starts with understanding your current setup and what kind of support would actually help — not a one-size-fits-all pitch.',
      },
      {
        heading: 'Properties for Shoots and Long Stays',
        body: 'Separately from hotel management, we also help connect production teams and long-stay guests with suitable properties in our network for shoots, photography, film work and extended stays. If you have a location or duration requirement, share it with us through the enquiry form and we will check what is available.',
      },
    ],
    faqs: [
    ...
    seo: {
      title: 'Shrinath Hospitality | Hotel Marketing & Management',
      description: 'Shrinath Hospitality provides marketing, direct-enquiry, OTA distribution and management support for hotels and resorts around Jaisalmer.',
      canonicalPath: '/our-ventures/shrinath-hospitality',
    },
  },

  {
    ...
    phoneNumbers: ['9694994940'],
    website: 'https://jaisalmeradventures.com/',
    googleBusinessUrl: 'https://share.google/y3e6XciY7FJXaloCm',
    theme: {
      layoutVariant: 'offbeat-expedition',
      primary: '#8a6a3f',
      secondary: '#4a5233',
      accent: '#c2b280',
      background: '#141210',
    ...
    sections: [
      {
        heading: 'The Difference Between a Dune Visit and an Offbeat Safari',
        body: 'Most Jaisalmer desert trips follow the same well-travelled dune circuit — the same viewpoint, the same crowd, the same photograph. Jaisalmer Adventures is built for travellers who want something else: quieter camel trails, jeep routes through village and desert landscapes, and sunset or stargazing spots that are not part of the standard tourist stop list.',
      },
      {
        heading: 'Responsible Travel in the Desert',
    ...
    seo: {
      title: 'Jaisalmer Adventures | Non-Touristic Desert Safaris',
      description: 'Jaisalmer Adventures offers offbeat, non-touristic desert safaris around Jaisalmer — quiet camel trails, jeep routes and responsible desert travel.',
      canonicalPath: '/our-ventures/jaisalmer-adventures',
    },
  },

  {
    ...
    phoneNumbers: ['9549484949'],
    email: 'myjaisalmer@gmail.com',
    website: 'https://myjaisalmer.com/',
    theme: {
      layoutVariant: 'directory-portal',
      primary: '#0b3d91',
      secondary: '#0b3d91',
      accent: '#f2b705',
      background: '#ffffff',
    ...
    sections: [
      {
        heading: 'A Local Directory Built for Jaisalmer',
        body: 'My Jaisalmer is a local Yellow Pages-style directory bringing together hotels, camps, restaurants, taxis, shops, services and attractions in one place. Instead of searching separately for each category, visitors and residents can use My Jaisalmer as a starting point for finding what the city has to offer.',
      },
      {
        heading: 'Useful for Residents, Visitors and Local Businesses',
        body: 'Residents get a quick reference for everyday local services. Visitors get a simpler way to explore the city’s hotels, dining and attractions beyond the most obvious tourist listings. Local businesses get a channel to be discoverable to both audiences without building their own directory presence from scratch.',
      },
      {
        heading: 'Add Your Business',
        body: 'If you run a business in Jaisalmer and want to be listed, reach out through the contact details on this page. We will walk you through the listing-enquiry process and what information is needed to get your business included in the relevant category.',
      },
    ],
    faqs: [
    ...
    seo: {
      title: 'My Jaisalmer | Jaisalmer Yellow Pages & Business Directory',
      description: 'My Jaisalmer is a local business directory covering hotels, camps, restaurants, taxis, shopping, services and attractions across Jaisalmer.',
      canonicalPath: '/our-ventures/my-jaisalmer',
    },
  },

  {
    ...
    phoneNumbers: ['9549484949'],
    email: 'shrinathhospitality@gmail.com',
    website: 'https://welcometojaisalmer.com/',
    theme: {
      layoutVariant: 'editorial-guide',
      primary: '#8a1c1c',
      secondary: '#c9a24b',
      accent: '#1e2a5e',
      background: '#fbf7ee',
    ...
    seo: {
      title: 'Welcome to Jaisalmer | Jaisalmer Travel Guide',
      description: 'Welcome to Jaisalmer is a destination travel guide covering attractions, itineraries, desert experiences and hotels for visitors planning a Jaisalmer trip.',
      canonicalPath: '/our-ventures/welcome-to-jaisalmer',
    },
  },
];
...
export function getAdjacentVentures(slug: string): { prev: Venture | null; next: Venture | null } {
